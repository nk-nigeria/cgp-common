...
type BlackjackUpdateDesk struct {
	...
	PlayerAction         *BlackjackAction       `protobuf:"bytes,14,opt,name=player_action,json=playerAction,proto3" json:"player_action,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *BlackjackUpdateDesk) GetPlayerAction() *BlackjackAction {
	if x != nil {
...
const file_blackjack_proto_rawDesc = "" +
	...
	"\ahand_n0\x18\x03 \x01(\x0e2\x16.proto.BlackjackHandN0R\x06handN0\"\x9c\x05\n" +
	...
	"playersBet\x12\"\n" +
	"\x05error\x18\r \x01(\v2\f.proto.ErrorR\x05error\x12;\n" +
	"\rplayer_action\x18\x0e \x01(\v2\x16.proto.BlackjackActionR\fplayerAction\"Y\n" +
...
var file_blackjack_proto_depIdxs = []int32{
	...
	5,  // 22: proto.BlackjackUpdateDesk.player_action:type_name -> proto.BlackjackAction
	9,  // 23: proto.BlackjackUpdateFinish.bet_results:type_name -> proto.BlackjackPLayerBetResult
