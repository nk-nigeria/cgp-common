...
const file_gaple_api_proto_rawDesc = "" +
	"\n" +
	"\x0fgaple_api.proto\x12\x03api\x1a\x12bandarqq_api.proto\x1a\x1cchinese_poker_game_api.proto\"\x8c\x01\n" +
	"\x11GapleDominoAction\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12#\n" +
	"\x06domino\x18\x02 \x01(\v2\v.api.DominoR\x06domino\x129\n" +
	"\bposition\x18\x03 \x01(\x0e2\x1d.api.GapleDominoChainPositionR\bposition\"\xb2\x02\n" +
	...
	"\x1dlost_player_not_have_facelets\x18\x04 \x03(\x05R\x19lostPlayerNotHaveFacelets\x12@\n" +
	"\x12gain_player_wallet\x18\x05 \x01(\v2\x12.api.BalanceUpdateR\x10gainPlayerWallet\x12@\n" +
	"\x12lost_player_wallet\x18\x06 \x01(\v2\x12.api.BalanceUpdateR\x10lostPlayerWallet\"\\\n" +
	"\x14GapleDominoChainNode\x12#\n" +
	"\x06domino\x18\x01 \x01(\v2\v.api.DominoR\x06domino\x12\x1f\n" +
	...
	"\x1bis_update_num_remained_card\x18\a \x01(\bR\x17isUpdateNumRemainedCard\x12/\n" +
	"\x05chain\x18\b \x03(\v2\x19.api.GapleDominoChainNodeR\x05chain\x12.\n" +
	"\x06action\x18\t \x01(\v2\x16.api.GapleDominoActionR\x06action\x12;\n" +
	"\rlegal_actions\x18\n" +
	" \x03(\v2\x16.api.GapleDominoActionR\flegalActions\x121\n" +
	"\apenalty\x18\v \x01(\v2\x17.api.GapleDominoPenaltyR\apenalty\x12A\n" +
	"\tremaineds\x18\f \x03(\v2#.api.GapleDominoPresenceNumRemainedR\tremaineds\x12\x17\n" +
	...
	"\bnum_card\x18\x02 \x01(\x05R\anumCard\"Y\n" +
	"\x17GapleDominoPresenceHand\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12%\n" +
	"\adominos\x18\x02 \x03(\v2\v.api.DominoR\adominos\"y\n" +
	"\x15GapleDominoUpdateDeal\x120\n" +
	"\x04hand\x18\x01 \x01(\v2\x1c.api.GapleDominoPresenceHandR\x04hand\x12.\n" +
	"\x04desk\x18\x02 \x01(\v2\x1a.api.GapleDominoUpdateDeskR\x04desk\";\n" +
	"\n" +
	"LewatCount\x12\x17\n" +
	...
	"ResultChip\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12%\n" +
	"\x0ebalance_change\x18\x02 \x01(\x03R\rbalanceChange\"\xeb\x01\n" +
	"\x17GapleDoninoUpdateFinish\x122\n" +
	"\x04type\x18\x01 \x01(\x0e2\x1e.api.GapleDominoFinishGameTypeR\x04type\x12\x16\n" +
	"\x06winner\x18\x02 \x01(\tR\x06winner\x122\n" +
	"\x05hands\x18\x03 \x03(\v2\x1c.api.GapleDominoPresenceHandR\x05hands\x12'\n" +
	"\x06lewats\x18\x04 \x03(\v2\x0f.api.LewatCountR\x06lewats\x12'\n" +
	"\x06result\x18\x05 \x03(\v2\x0f.api.ResultChipR\x06result*\x85\x02\n" +
	...
	"BGAPLE_DOMINO_FINISH_GAME_TYPE_GAPLE_DOMINO_FINISHGAME_TYPE_QUINTET\x10\x05B0Z.github.com/nakamaFramework/cgp-bing-module/apib\x06proto3"

var (
	file_gaple_api_proto_rawDescOnce sync.Once
	file_gaple_api_proto_rawDescData []byte
)

func file_gaple_api_proto_rawDescGZIP() []byte {
	file_gaple_api_proto_rawDescOnce.Do(func() {
		file_gaple_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_gaple_api_proto_rawDesc), len(file_gaple_api_proto_rawDesc)))
	})
...
func file_gaple_api_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_gaple_api_proto_rawDesc), len(file_gaple_api_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
