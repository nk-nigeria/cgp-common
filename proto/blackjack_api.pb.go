...
const file_blackjack_api_proto_rawDesc = "" +
	"\n" +
	"\x13blackjack_api.proto\x12\x03api\x1a\x1cchinese_poker_game_api.proto\x1a\x10common_api.proto\"X\n" +
	"\x0fBlackjackAction\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12,\n" +
	"\x04code\x18\x02 \x01(\x0e2\x18.api.BlackjackActionCodeR\x04code\"h\n" +
	"\fBlackjackBet\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x14\n" +
	"\x05chips\x18\x02 \x01(\x03R\x05chips\x12)\n" +
	"\x04code\x18\x03 \x01(\x0e2\x15.api.BlackjackBetCodeR\x04code\"\x7f\n" +
	...
	"\x06is_win\x18\x04 \x01(\x05R\x05isWin\"\xa7\x01\n" +
	...
	"\abalance\x18\x0e \x01(\v2\x12.api.BalanceUpdateR\abalance\"\xca\x01\n" +
	"\x18BlackjackPLayerBetResult\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x125\n" +
	"\tinsurance\x18\x02 \x01(\v2\x17.api.BlackjackBetResultR\tinsurance\x12-\n" +
	"\x05first\x18\x03 \x01(\v2\x17.api.BlackjackBetResultR\x05first\x12/\n" +
	"\x06second\x18\x04 \x01(\v2\x17.api.BlackjackBetResultR\x06second\"\xd2\x02\n" +
	...
	"\ahand_n0\x18\x04 \x01(\x0e2\x14.api.BlackjackHandN0R\x06handN0\x12&\n" +
	"\tnew_cards\x18\x05 \x03(\v2\t.api.CardR\bnewCards\x12,\n" +
	"\x04hand\x18\x06 \x01(\v2\x18.api.BlackjackPlayerHandR\x04hand\x12@\n" +
	"\x0fall_player_hand\x18\a \x03(\v2\x18.api.BlackjackPlayerHandR\rallPlayerHand\"d\n" +
	"\x15BlackjackLegalActions\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x122\n" +
	"\aactions\x18\x02 \x03(\x0e2\x18.api.BlackjackActionCodeR\aactions\"\xce\x01\n" +
	"\rBlackjackHand\x12\x1f\n" +
	"\x05cards\x18\x01 \x03(\v2\t.api.CardR\x05cards\x12*\n" +
	"\x04type\x18\x02 \x01(\x0e2\x16.api.BlackjackHandTypeR\x04type\x12\x14\n" +
	"\x05point\x18\x03 \x01(\x05R\x05point\x12 \n" +
	"\fpoint_card_a\x18\x04 \x01(\tR\n" +
	"pointCardA\x12\x1b\n" +
	"\tmin_point\x18\x05 \x01(\x05R\bminPoint\x12\x1b\n" +
	"\tmax_point\x18\x06 \x01(\x05R\bmaxPoint\"\x84\x01\n" +
	"\x13BlackjackPlayerHand\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12(\n" +
	"\x05first\x18\x02 \x01(\v2\x12.api.BlackjackHandR\x05first\x12*\n" +
	"\x06second\x18\x03 \x01(\v2\x12.api.BlackjackHandR\x06second\"z\n" +
	"\x13BlackjackPlayerTurn\x12\x1b\n" +
	"\tis_player\x18\x01 \x01(\tR\bisPlayer\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12-\n" +
	"\ahand_n0\x18\x03 \x01(\x0e2\x14.api.BlackjackHandN0R\x06handN0\"\xd3\x04\n" +
	...
	"\x03bet\x18\x06 \x01(\v2\x17.api.BlackjackPlayerBetR\x03bet\x123\n" +
	"\x16is_update_legal_action\x18\a \x01(\bR\x13isUpdateLegalAction\x124\n" +
	"\aactions\x18\b \x01(\v2\x1a.api.BlackjackLegalActionsR\aactions\x12\"\n" +
	"\ris_split_hand\x18\t \x01(\bR\visSplitHand\x12,\n" +
	"\x04hand\x18\n" +
	" \x01(\v2\x18.api.BlackjackPlayerHandR\x04hand\x125\n" +
	"\x17is_banker_not_blackjack\x18\v \x01(\bR\x14isBankerNotBlackjack\x128\n" +
	"\vplayers_bet\x18\f \x03(\v2\x17.api.BlackjackPlayerBetR\n" +
	"playersBet\x12 \n" +
	"\x05error\x18\r \x01(\v2\n" +
	".api.ErrorR\x05error\"W\n" +
	"\x15BlackjackUpdateFinish\x12>\n" +
	"\vbet_results\x18\x01 \x03(\v2\x1d.api.BlackjackPLayerBetResultR\n" +
	"betResults*\xb8\x01\n" +
	...
	"\x12BLACKJACK_HAND_2ND\x10\x02B0Z.github.com/nakamaFramework/cgp-bing-module/apib\x06proto3"

var (
	file_blackjack_api_proto_rawDescOnce sync.Once
	file_blackjack_api_proto_rawDescData []byte
)

func file_blackjack_api_proto_rawDescGZIP() []byte {
	file_blackjack_api_proto_rawDescOnce.Do(func() {
		file_blackjack_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_blackjack_api_proto_rawDesc), len(file_blackjack_api_proto_rawDesc)))
	})
...
func file_blackjack_api_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_blackjack_api_proto_rawDesc), len(file_blackjack_api_proto_rawDesc)),
			NumEnums:      5,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
