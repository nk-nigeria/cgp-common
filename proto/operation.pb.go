...
var file_operation_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x74, 0x73, 0x2a, 0x4b, 0x0a, 0x0e, 0x43, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79,
...
var file_operation_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_operation_proto_goTypes = []interface{}{
	...
	nil,                           // 34: api.CashInfo.NumTransByCurrencyValueEntry
	(*Profile)(nil),               // 35: api.Profile
}
var file_operation_proto_depIdxs = []int32{
	...
	35, // 9: api.UserInfo.profile:type_name -> api.Profile
	...
	34, // 15: api.CashInfo.num_trans_by_currency_value:type_name -> api.CashInfo.NumTransByCurrencyValueEntry
