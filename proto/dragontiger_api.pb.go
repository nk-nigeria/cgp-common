...
var file_dragontiger_api_proto_rawDesc = []byte{
	...
	0x5f, 0x42, 0x45, 0x54, 0x10, 0x02, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_dragontiger_api_proto_goTypes = []interface{}{
...
func file_dragontiger_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_dragontiger_api_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_dragontiger_api_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
