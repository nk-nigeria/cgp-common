...
const (
	SicboBetCell_CELL_UNSPECIFIED SicboBetCell = 0 // unused
	SicboBetCell_CELL_SMALL       SicboBetCell = 1 // x1
	SicboBetCell_CELL_BIG         SicboBetCell = 2
	SicboBetCell_CELL_1           SicboBetCell = 3 // x number of same face
	SicboBetCell_CEll_2           SicboBetCell = 4
	SicboBetCell_CELL_3           SicboBetCell = 5
	SicboBetCell_CELL_4           SicboBetCell = 6
	SicboBetCell_CELL_5           SicboBetCell = 7
	SicboBetCell_CELL_6           SicboBetCell = 8
	SicboBetCell_CELL_DOUBLE_1    SicboBetCell = 9 // x10
	SicboBetCell_CELL_DOUBLE_2    SicboBetCell = 10
	SicboBetCell_CELL_DOUBLE_3    SicboBetCell = 11
	SicboBetCell_CELL_DOUBLE_4    SicboBetCell = 12
	SicboBetCell_CELL_DOUBLE_5    SicboBetCell = 13
	SicboBetCell_CELL_DOUBLE_6    SicboBetCell = 14
	SicboBetCell_CELL_TRIPLE_1    SicboBetCell = 15 // x30
	SicboBetCell_CELL_TRIPLE_2    SicboBetCell = 16
	SicboBetCell_CELL_TRIPLE_3    SicboBetCell = 17
	SicboBetCell_CELL_TRIPLE_4    SicboBetCell = 18
	SicboBetCell_CELL_TRIPLE_5    SicboBetCell = 19
	SicboBetCell_CELL_TRIPLE_6    SicboBetCell = 20
	SicboBetCell_CELL_TOTAL_4     SicboBetCell = 21 // x60
	SicboBetCell_CELL_TOTAL_17    SicboBetCell = 22
	SicboBetCell_CELL_TOTAL_5     SicboBetCell = 23 // x30
	SicboBetCell_CELL_TOTAL_16    SicboBetCell = 24
	SicboBetCell_CELL_TOTAL_6     SicboBetCell = 25 // x18
	SicboBetCell_CELL_TOTAL_15    SicboBetCell = 26
	SicboBetCell_CELL_TOTAL_7     SicboBetCell = 27 // x12
	SicboBetCell_CELL_TOTAL_14    SicboBetCell = 28
	SicboBetCell_CELL_TOTAL_8     SicboBetCell = 29 // x8
	SicboBetCell_CELL_TOTAL_13    SicboBetCell = 30
	SicboBetCell_CELL_TOTAL_9     SicboBetCell = 31 // x7
	SicboBetCell_CELL_TOTAL_12    SicboBetCell = 32
	SicboBetCell_CELL_TOTAL_10    SicboBetCell = 33 // x6
	SicboBetCell_CELL_TOTAL_11    SicboBetCell = 34
)
...
const (
	SicboBetAction_NORMAL SicboBetAction = 0
	SicboBetAction_REBET  SicboBetAction = 1
	SicboBetAction_DOUBLE SicboBetAction = 2
)
...
const (
	SicboBetRejectReason_BALANCE_NOT_ENOUGH     SicboBetRejectReason = 0
	SicboBetRejectReason_PREVIOUS_BET_NOT_EXIST SicboBetRejectReason = 1
	SicboBetRejectReason_ALREADY_BET            SicboBetRejectReason = 2
)

// Enum value maps for SicboBetRejectReason.
var (
	SicboBetRejectReason_name = map[int32]string{
		0: "BALANCE_NOT_ENOUGH",
		1: "PREVIOUS_BET_NOT_EXIST",
		2: "ALREADY_BET",
	}
	SicboBetRejectReason_value = map[string]int32{
		"BALANCE_NOT_ENOUGH":     0,
		"PREVIOUS_BET_NOT_EXIST": 1,
		"ALREADY_BET":            2,
	}
)
...
func (x *SicboBet) GetCell() SicboBetCell {
	...
	return SicboBetCell_CELL_UNSPECIFIED
}
...
type SicboGameFinish struct {
	...
	LetBetResult []*SicboPlayerBetResult `protobuf:"bytes,4,rep,name=let_bet_result,json=letBetResult,proto3" json:"let_bet_result,omitempty"`
}
...
func (x *SicboGameFinish) GetLetBetResult() []*SicboPlayerBetResult {
	if x != nil {
		return x.LetBetResult
	}
	return nil
}
...
func (x *SicboActionReject) GetReason() SicboBetRejectReason {
	...
	return SicboBetRejectReason_BALANCE_NOT_ENOUGH
}
...
var file_sicbo_api_proto_rawDesc = []byte{
	...
	0x2e, 0x44, 0x69, 0x63, 0x65, 0x52, 0x05, 0x64, 0x69, 0x63, 0x65, 0x73, 0x22, 0xa6, 0x01, 0x0a,
	...
	,
	...
	0x72, 0x42, 0x65, 0x74, 0x22, 0xcd, 0x02, 0x0a, 0x0f, 0x53, 0x69, 0x63, 0x62, 0x6f, 0x55, 0x70,
	...
	,
...
var file_sicbo_api_proto_depIdxs = []int32{
	...
	7,  // 8: api.SicboGameFinish.let_bet_result:type_name -> api.SicboPlayerBetResult
