...
const file_sicbo_api_proto_rawDesc = "" +
	"\n" +
	"\x0fsicbo_api.proto\x12\x03api\"G\n" +
	"\bSicboBet\x12\x14\n" +
	"\x05chips\x18\x02 \x01(\x03R\x05chips\x12%\n" +
	"\x04cell\x18\x03 \x01(\x0e2\x11.api.SicboBetCellR\x04cell\"H\n" +
	"\x0eSicboBetResult\x12\x1f\n" +
	"\x03bet\x18\x01 \x01(\v2\r.api.SicboBetR\x03bet\x12\x15\n" +
	"\x06is_win\x18\x02 \x01(\bR\x05isWin\"y\n" +
	"\x0eSicboPlayerBet\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12+\n" +
	"\x06action\x18\x02 \x01(\x0e2\x13.api.SicboBetActionR\x06action\x12!\n" +
	"\x04bets\x18\x03 \x03(\v2\r.api.SicboBetR\x04bets\"X\n" +
	"\x14SicboPlayerBetResult\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12'\n" +
	"\x04list\x18\x02 \x03(\v2\x13.api.SicboBetResultR\x04list\",\n" +
	"\tSicboHand\x12\x1f\n" +
	"\x05dices\x18\x01 \x03(\x0e2\t.api.DiceR\x05dices\"\xa8\x01\n" +
	"\x0fSicboGameFinish\x12\"\n" +
	"\x04hand\x18\x01 \x01(\v2\x0e.api.SicboHandR\x04hand\x12.\n" +
	"\twin_cells\x18\x03 \x03(\x0e2\x11.api.SicboBetCellR\bwinCells\x12A\n" +
	"\x0flist_bet_result\x18\x04 \x03(\v2\x19.api.SicboPlayerBetResultR\rlistBetResult\"m\n" +
	"\x10SicboBetCellInfo\x12%\n" +
	"\x04cell\x18\x01 \x01(\x0e2\x11.api.SicboBetCellR\x04cell\x12\x14\n" +
	"\x05chips\x18\x02 \x01(\x03R\x05chips\x12\x1c\n" +
	"\n" +
	"n_user_bet\x18\x03 \x01(\x05R\bnUserBet\"\xcd\x02\n" +
	...
	"\x16is_update_game_history\x18\x04 \x01(\bR\x13isUpdateGameHistory\x12.\n" +
	"\buser_bet\x18\x05 \x01(\v2\x13.api.SicboPlayerBetR\auserBet\x122\n" +
	"\tdesk_cell\x18\x06 \x03(\v2\x15.api.SicboBetCellInfoR\bdeskCell\x12(\n" +
	"\ahistory\x18\a \x03(\v2\x0e.api.SicboHandR\ahistory\"F\n" +
	"\x11SicboActionReject\x121\n" +
	"\x06reason\x18\x01 \x01(\x0e2\x19.api.SicboBetRejectReasonR\x06reason*e\n" +
	"\x04Dice\x12\x15\n" +
	...
	"\vALREADY_BET\x10\x03B0Z.github.com/nakamaFramework/cgp-bing-module/apib\x06proto3"

var (
	file_sicbo_api_proto_rawDescOnce sync.Once
	file_sicbo_api_proto_rawDescData []byte
)

func file_sicbo_api_proto_rawDescGZIP() []byte {
	file_sicbo_api_proto_rawDescOnce.Do(func() {
		file_sicbo_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_sicbo_api_proto_rawDesc), len(file_sicbo_api_proto_rawDesc)))
	})
...
func file_sicbo_api_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_sicbo_api_proto_rawDesc), len(file_sicbo_api_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
