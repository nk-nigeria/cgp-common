    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.chipsMcb = longToNumber(reader.int64());
          continue;
        }
        case 7: {
          if (tag !== 56) {
        ...
        case 21: {
          ...
          message.tsUnix = longToNumber(reader.int64());
          continue;
        }
        case 22: {
          if (tag !== 176) {
          ...
          message.ratioFruitBasket = longToNumber(reader.int64());
          continue;
        }
        case 23: {
          if (tag !== 184) {
          ...
          message.numSpinLeft = longToNumber(reader.int64());
          continue;
        }
        case 24: {
          if (tag === 192) {
            message.betLevels.push(longToNumber(reader.int64()));
        ...
        case 26: {
          ...
          message.chipsBuyGem = longToNumber(reader.int64());
          continue;
        }
        case 27: {
          if (tag === 216) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.numScatterSeq = longToNumber(reader.int64());
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.numFreeSpin = longToNumber(reader.int64());
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.numWild = longToNumber(reader.int64());
          continue;
        }
        case 4: {
          if (tag !== 37) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.qty = longToNumber(reader.int64());
          continue;
        }
        case 3: {
          if (tag !== 29) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.ratio = longToNumber(reader.int64());
          continue;
        }
        case 3: {
          if (tag !== 24) {
        ...
        case 5: {
          ...
          message.chipsAccum = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.balanceChipsWalletBefore = longToNumber(reader.int64());
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.balanceChipsWalletAfter = longToNumber(reader.int64());
          continue;
        }
        case 4: {
          if (tag !== 32) {
        ...
        case 5: {
          ...
          message.totalChipsWinByGame = longToNumber(reader.int64());
          continue;
        }
        case 6: {
          if (tag !== 48) {
        ...
        case 9: {
          ...
          message.lineWin = longToNumber(reader.int64());
          continue;
        }
        case 10: {
          if (tag !== 85) {
        ...
        case 11: {
          ...
          message.totalLineWin = longToNumber(reader.int64());
          continue;
        }
        case 12: {
          if (tag !== 96) {
          ...
          message.chipBetFee = longToNumber(reader.int64());
          continue;
        }
        case 13: {
          if (tag !== 104) {
        ...
        case 16: {
          ...
          message.perlGreenForestChips = longToNumber(reader.int64());
          continue;
        }
        case 17: {
          if (tag !== 136) {
          ...
          message.perlGreenForestChipsCollect = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.lastUpdateUnix = longToNumber(reader.int64());
          continue;
        }
        case 2: {
          if (tag !== 18) {
