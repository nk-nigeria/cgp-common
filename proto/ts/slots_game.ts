...
export interface GameReward {
  ...
  /** số chip trong wallet trước spin */
  balanceChipsWalletBefore: string;
  /** số chip trong wallet sau spin */
  balanceChipsWalletAfter: string;
  ...
  perlGreenForestChips: string;
  perlGreenForestChipsCollect: string;
}
...
export const SlotDesk: MessageFns<SlotDesk> = {
  encode(message: SlotDesk, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.matrix !== undefined) {
      SlotMatrix.encode(message.matrix, writer.uint32(10).fork()).join();
    }
    if (message.spreadMatrix !== undefined) {
      SlotMatrix.encode(message.spreadMatrix, writer.uint32(34).fork()).join();
    }
    for (const v of message.paylines) {
      Payline.encode(v!, writer.uint32(42).fork()).join();
    }
    ...
    if (message.gameReward !== undefined) {
      GameReward.encode(message.gameReward, writer.uint32(114).fork()).join();
    }
    for (const v of message.collectionSymbols) {
      CollectSymbol.encode(v!, writer.uint32(130).fork()).join();
    }
    if (message.tsUnix !== "0") {
    ...
    if (message.infoBet !== undefined) {
      InfoBet.encode(message.infoBet, writer.uint32(202).fork()).join();
    }
    ...
    if (message.winJpHistory !== undefined) {
      JackpotHistory.encode(message.winJpHistory, writer.uint32(234).fork()).join();
    }
    if (message.gameConfig !== undefined) {
      GameConfig.encode(message.gameConfig, writer.uint32(242).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SlotDesk {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.chipsMcb = reader.int64().toString();
          continue;
        }
        case 7: {
          if (tag !== 56) {
        ...
        case 21: {
          ...
          message.tsUnix = reader.int64().toString();
          continue;
        }
        case 22: {
          if (tag !== 176) {
          ...
          message.ratioFruitBasket = reader.int64().toString();
          continue;
        }
        case 23: {
          if (tag !== 184) {
          ...
          message.numSpinLeft = reader.int64().toString();
          continue;
        }
        case 24: {
          if (tag === 192) {
            message.betLevels.push(reader.int64().toString());
        ...
        case 26: {
          ...
          message.chipsBuyGem = reader.int64().toString();
          continue;
        }
        case 27: {
          if (tag === 216) {
  ...
  fromJSON(object: any): SlotDesk {
    return {
      ...
      chipsMcb: isSet(object.chipsMcb) ? globalThis.String(object.chipsMcb) : "0",
      ...
      collectionSymbols: globalThis.Array.isArray(object?.collectionSymbols)
        ...
        : [],
      tsUnix: isSet(object.tsUnix) ? globalThis.String(object.tsUnix) : "0",
      ratioFruitBasket: isSet(object.ratioFruitBasket) ? globalThis.String(object.ratioFruitBasket) : "0",
      numSpinLeft: isSet(object.numSpinLeft) ? globalThis.String(object.numSpinLeft) : "0",
      betLevels: globalThis.Array.isArray(object?.betLevels)
        ? object.betLevels.map((e: any) => globalThis.String(e))
        : [],
      infoBet: isSet(object.infoBet) ? InfoBet.fromJSON(object.infoBet) : undefined,
      chipsBuyGem: isSet(object.chipsBuyGem) ? globalThis.String(object.chipsBuyGem) : "0",
  ...
  toJSON(message: SlotDesk): unknown {
    ...
    if (message.tsUnix !== "0") {
      obj.tsUnix = message.tsUnix;
    }
    if (message.ratioFruitBasket !== "0") {
      obj.ratioFruitBasket = message.ratioFruitBasket;
    }
    if (message.numSpinLeft !== "0") {
      obj.numSpinLeft = message.numSpinLeft;
    }
    if (message.betLevels?.length) {
      obj.betLevels = message.betLevels;
    }
    if (message.infoBet !== undefined) {
      obj.infoBet = InfoBet.toJSON(message.infoBet);
    }
    if (message.chipsBuyGem !== "0") {
      obj.chipsBuyGem = message.chipsBuyGem;
    }
...
export const GameConfig: MessageFns<GameConfig> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.numScatterSeq = reader.int64().toString();
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.numFreeSpin = reader.int64().toString();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.numWild = reader.int64().toString();
          continue;
        }
        case 4: {
          if (tag !== 37) {
  ...
  fromJSON(object: any): GameConfig {
    return {
      numScatterSeq: isSet(object.numScatterSeq) ? globalThis.String(object.numScatterSeq) : "0",
      numFreeSpin: isSet(object.numFreeSpin) ? globalThis.String(object.numFreeSpin) : "0",
      numWild: isSet(object.numWild) ? globalThis.String(object.numWild) : "0",
  ...
  toJSON(message: GameConfig): unknown {
    const obj: any = {};
    if (message.numScatterSeq !== "0") {
      obj.numScatterSeq = message.numScatterSeq;
    }
    if (message.numFreeSpin !== "0") {
      obj.numFreeSpin = message.numFreeSpin;
    }
    if (message.numWild !== "0") {
      obj.numWild = message.numWild;
    }
    if (message.ratioWild !== 0) {
...
export const SlotMatrix: MessageFns<SlotMatrix> = {
  encode(message: SlotMatrix, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.spinLists) {
      SpinSymbol.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SlotMatrix {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SpinSymbol: MessageFns<SpinSymbol> = {
  encode(message: SpinSymbol, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.symbol !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SpinSymbol {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.winAmount = reader.int64().toString();
          continue;
        }
        case 8: {
          if (tag !== 69) {
  ...
  fromJSON(object: any): SpinSymbol {
    return {
      ...
      winJp: isSet(object.winJp) ? winJackpotFromJSON(object.winJp) : 0,
      winAmount: isSet(object.winAmount) ? globalThis.String(object.winAmount) : "0",
  ...
  toJSON(message: SpinSymbol): unknown {
    ...
    if (message.winAmount !== "0") {
      obj.winAmount = message.winAmount;
    }
    if (message.ratioBonus !== 0) {
...
export const CollectSymbol: MessageFns<CollectSymbol> = {
  encode(message: CollectSymbol, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.symbol !== 0) {
      writer.uint32(8).int32(message.symbol);
    }
    if (message.qty !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CollectSymbol {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.qty = reader.int64().toString();
          continue;
        }
        case 3: {
          if (tag !== 29) {
  ...
  fromJSON(object: any): CollectSymbol {
    return {
      symbol: isSet(object.symbol) ? siXiangSymbolFromJSON(object.symbol) : 0,
      qty: isSet(object.qty) ? globalThis.String(object.qty) : "0",
      ratio: isSet(object.ratio) ? globalThis.Number(object.ratio) : 0,
    };
  },
...
export const JackpotReward: MessageFns<JackpotReward> = {
  encode(message: JackpotReward, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): JackpotReward {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.ratio = reader.int64().toString();
          continue;
        }
        case 3: {
          if (tag !== 24) {
        ...
        case 5: {
          ...
          message.chipsAccum = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): JackpotReward {
    return {
      ...
      ratio: isSet(object.ratio) ? globalThis.String(object.ratio) : "0",
      count: isSet(object.count) ? globalThis.String(object.count) : "0",
      chips: isSet(object.chips) ? globalThis.String(object.chips) : "0",
      chipsAccum: isSet(object.chipsAccum) ? globalThis.String(object.chipsAccum) : "0",
    };
  },
  ...
  toJSON(message: JackpotReward): unknown {
    ...
    if (message.chipsAccum !== "0") {
      obj.chipsAccum = message.chipsAccum;
    }
    return obj;
  },
...
export const JackpotHistory: MessageFns<JackpotHistory> = {
  encode(message: JackpotHistory, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.minor !== undefined) {
      JackpotReward.encode(message.minor, writer.uint32(10).fork()).join();
    }
    if (message.major !== undefined) {
      JackpotReward.encode(message.major, writer.uint32(18).fork()).join();
    }
    if (message.mega !== undefined) {
      JackpotReward.encode(message.mega, writer.uint32(26).fork()).join();
    }
    if (message.grand !== undefined) {
      JackpotReward.encode(message.grand, writer.uint32(34).fork()).join();
    }
    if (message.mini !== undefined) {
      JackpotReward.encode(message.mini, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): JackpotHistory {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const Payline: MessageFns<Payline> = {
  encode(message: Payline, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Payline {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const GameReward: MessageFns<GameReward> = {
  encode(message: GameReward, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.updateWallet !== false) {
    ...
    if (message.updateChipsBonus !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GameReward {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.balanceChipsWalletBefore = reader.int64().toString();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.balanceChipsWalletAfter = reader.int64().toString();
          continue;
        }
        case 4: {
          if (tag !== 32) {
        ...
        case 5: {
          ...
          message.totalChipsWinByGame = reader.int64().toString();
          continue;
        }
        case 6: {
          if (tag !== 48) {
        ...
        case 9: {
          ...
          message.lineWin = reader.int64().toString();
          continue;
        }
        case 10: {
          if (tag !== 85) {
        ...
        case 11: {
          ...
          message.totalLineWin = reader.int64().toString();
          continue;
        }
        case 12: {
          if (tag !== 96) {
          ...
          message.chipBetFee = reader.int64().toString();
          continue;
        }
        case 13: {
          if (tag !== 104) {
        ...
        case 16: {
          ...
          message.perlGreenForestChips = reader.int64().toString();
          continue;
        }
        case 17: {
          if (tag !== 136) {
          ...
          message.perlGreenForestChipsCollect = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GameReward {
    return {
      ...
      balanceChipsWalletBefore: isSet(object.balanceChipsWalletBefore)
        ? globalThis.String(object.balanceChipsWalletBefore)
        : "0",
      balanceChipsWalletAfter: isSet(object.balanceChipsWalletAfter)
        ? globalThis.String(object.balanceChipsWalletAfter)
        : "0",
      chipsWin: isSet(object.chipsWin) ? globalThis.String(object.chipsWin) : "0",
      totalChipsWinByGame: isSet(object.totalChipsWinByGame) ? globalThis.String(object.totalChipsWinByGame) : "0",
      ...
      lineWin: isSet(object.lineWin) ? globalThis.String(object.lineWin) : "0",
      totalRatioWin: isSet(object.totalRatioWin) ? globalThis.Number(object.totalRatioWin) : 0,
      totalLineWin: isSet(object.totalLineWin) ? globalThis.String(object.totalLineWin) : "0",
      chipBetFee: isSet(object.chipBetFee) ? globalThis.String(object.chipBetFee) : "0",
      ...
      perlGreenForestChips: isSet(object.perlGreenForestChips) ? globalThis.String(object.perlGreenForestChips) : "0",
      perlGreenForestChipsCollect: isSet(object.perlGreenForestChipsCollect)
        ? globalThis.String(object.perlGreenForestChipsCollect)
        : "0",
    };
  },
  ...
  toJSON(message: GameReward): unknown {
    ...
    if (message.balanceChipsWalletBefore !== "0") {
      obj.balanceChipsWalletBefore = message.balanceChipsWalletBefore;
    }
    if (message.balanceChipsWalletAfter !== "0") {
      obj.balanceChipsWalletAfter = message.balanceChipsWalletAfter;
    }
    if (message.chipsWin !== "0") {
      obj.chipsWin = message.chipsWin;
    }
    if (message.totalChipsWinByGame !== "0") {
      obj.totalChipsWinByGame = message.totalChipsWinByGame;
    }
    if (message.updateChipsBonus !== false) {
    ...
    if (message.lineWin !== "0") {
      obj.lineWin = message.lineWin;
    }
    if (message.totalRatioWin !== 0) {
      obj.totalRatioWin = message.totalRatioWin;
    }
    if (message.totalLineWin !== "0") {
      obj.totalLineWin = message.totalLineWin;
    }
    if (message.chipBetFee !== "0") {
      obj.chipBetFee = message.chipBetFee;
    }
    if (message.chipFee !== "0") {
    ...
    if (message.perlGreenForestChips !== "0") {
      obj.perlGreenForestChips = message.perlGreenForestChips;
    }
    if (message.perlGreenForestChipsCollect !== "0") {
      obj.perlGreenForestChipsCollect = message.perlGreenForestChipsCollect;
    }
    return obj;
  },
...
export const SaveGame: MessageFns<SaveGame> = {
  encode(message: SaveGame, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SaveGame {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.lastUpdateUnix = reader.int64().toString();
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): SaveGame {
    return {
      lastUpdateUnix: isSet(object.lastUpdateUnix) ? globalThis.String(object.lastUpdateUnix) : "0",
  ...
  toJSON(message: SaveGame): unknown {
    const obj: any = {};
    if (message.lastUpdateUnix !== "0") {
      obj.lastUpdateUnix = message.lastUpdateUnix;
    }
    if (message.data !== "") {
