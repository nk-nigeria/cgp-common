...
export interface QQGameFinish {
  ...
  playersWinAmount: { [key: string]: string };
}
...
export const Domino: MessageFns<Domino> = {
  encode(message: Domino, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.top !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Domino {
...
export const DominoList: MessageFns<DominoList> = {
  encode(message: DominoList, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.dominos) {
      Domino.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DominoList {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQBet: MessageFns<QQBet> = {
  encode(message: QQBet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.chips !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QQBet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQBetResult: MessageFns<QQBetResult> = {
  encode(message: QQBetResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.bet !== undefined) {
      QQBet.encode(message.bet, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QQBetResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQPlayerBets: MessageFns<QQPlayerBets> = {
  encode(message: QQPlayerBets, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    for (const v of message.bets) {
      QQBet.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QQPlayerBets {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQPlayerBetResult: MessageFns<QQPlayerBetResult> = {
  encode(message: QQPlayerBetResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    for (const v of message.betResults) {
      QQBetResult.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QQPlayerBetResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQListPlayerBetResult: MessageFns<QQListPlayerBetResult> = {
  encode(message: QQListPlayerBetResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.results) {
      QQPlayerBetResult.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QQListPlayerBetResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQHand: MessageFns<QQHand> = {
  encode(message: QQHand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.dominos) {
      Domino.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.type !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QQHand {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQPlayerEngameResult: MessageFns<QQPlayerEngameResult> = {
  encode(message: QQPlayerEngameResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    ...
    if (message.betResult !== undefined) {
      QQPlayerBetResult.encode(message.betResult, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QQPlayerEngameResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQGameFinish: MessageFns<QQGameFinish> = {
  encode(message: QQGameFinish, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.hands !== undefined) {
      QQGameFinishHand.encode(message.hands, writer.uint32(10).fork()).join();
    }
    ...
    if (message.result !== undefined) {
      QQPlayerEngameResult.encode(message.result, writer.uint32(34).fork()).join();
    }
    Object.entries(message.playersWinAmount).forEach(([key, value]) => {
      QQGameFinish_PlayersWinAmountEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QQGameFinish {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): QQGameFinish {
    return {
      ...
      playersWinAmount: isObject(object.playersWinAmount)
        ? Object.entries(object.playersWinAmount).reduce<{ [key: string]: string }>((acc, [key, value]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<QQGameFinish>, I>>(object: I): QQGameFinish {
    ...
    message.result = (object.result !== undefined && object.result !== null)
      ...
      : undefined;
    message.playersWinAmount = Object.entries(object.playersWinAmount ?? {}).reduce<{ [key: string]: string }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
...
export const QQGameFinish_PlayersWinAmountEntry: MessageFns<QQGameFinish_PlayersWinAmountEntry> = {
  encode(message: QQGameFinish_PlayersWinAmountEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QQGameFinish_PlayersWinAmountEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQGameFinishHand: MessageFns<QQGameFinishHand> = {
  encode(message: QQGameFinishHand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.redHand !== undefined) {
      QQHand.encode(message.redHand, writer.uint32(10).fork()).join();
    }
    if (message.blueHand !== undefined) {
      QQHand.encode(message.blueHand, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QQGameFinishHand {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQHistory: MessageFns<QQHistory> = {
  encode(message: QQHistory, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.handHistories) {
      QQGameFinishHand.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QQHistory {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQDeskCellBet: MessageFns<QQDeskCellBet> = {
  encode(message: QQDeskCellBet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.cell !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QQDeskCellBet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQDeskListCellBet: MessageFns<QQDeskListCellBet> = {
  encode(message: QQDeskListCellBet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.listCellBet) {
      QQDeskCellBet.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QQDeskListCellBet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QQUpdateDesk: MessageFns<QQUpdateDesk> = {
  encode(message: QQUpdateDesk, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.userBets !== undefined) {
      QQPlayerBets.encode(message.userBets, writer.uint32(42).fork()).join();
    }
    if (message.listCellBet !== undefined) {
      QQDeskListCellBet.encode(message.listCellBet, writer.uint32(50).fork()).join();
    }
    if (message.history !== undefined) {
      QQHistory.encode(message.history, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): QQUpdateDesk {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
