...
export const RpcFindMatchRequest: MessageFns<RpcFindMatchRequest> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.lastBet = reader.int64().toString();
          continue;
        }
        case 8: {
          if (tag !== 66) {
  ...
  fromJSON(object: any): RpcFindMatchRequest {
    return {
      ...
      lastBet: isSet(object.lastBet) ? globalThis.String(object.lastBet) : "0",
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 20: {
          ...
          message.pot = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Match {
    return {
      ...
      gameStateDuration: isObject(object.gameStateDuration)
        ...
        : {},
      pot: isSet(object.pot) ? globalThis.String(object.pot) : "0",
    };
  },
...
export const RpcCreateMatchRequest: MessageFns<RpcCreateMatchRequest> = {
  ...
  fromJSON(object: any): RpcCreateMatchRequest {
    return {
      ...
      password: isSet(object.password) ? globalThis.String(object.password) : "",
      lastBet: isSet(object.lastBet) ? globalThis.String(object.lastBet) : "0",
      maxSize: isSet(object.maxSize) ? globalThis.String(object.maxSize) : "0",
...
export const Bet: MessageFns<Bet> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.agJoin = reader.int64().toString();
          continue;
        }
        case 7: {
          if (tag !== 61) {
        ...
        case 8: {
          ...
          message.agPlayNow = reader.int64().toString();
          continue;
        }
        case 9: {
          if (tag !== 77) {
        ...
        case 10: {
          ...
          message.agLeave = reader.int64().toString();
          continue;
        }
        case 11: {
          if (tag !== 93) {
        ...
        case 12: {
          ...
          message.agFee = reader.int64().toString();
          continue;
        }
        case 13: {
          if (tag !== 109) {
        ...
        case 14: {
          ...
          message.countPlaying = reader.int64().toString();
          continue;
        }
        case 15: {
          if (tag !== 120) {
          ...
          message.minVip = reader.int64().toString();
          continue;
        }
        case 16: {
          if (tag !== 128) {
          ...
          message.maxVip = reader.int64().toString();
          continue;
        }
        case 17: {
          if (tag !== 136) {
  ...
  fromJSON(object: any): Bet {
    return {
      ...
      agJoin: isSet(object.agJoin) ? globalThis.String(object.agJoin) : "0",
      xPlayNow: isSet(object.xPlayNow) ? globalThis.Number(object.xPlayNow) : 0,
      agPlayNow: isSet(object.agPlayNow) ? globalThis.String(object.agPlayNow) : "0",
      xLeave: isSet(object.xLeave) ? globalThis.Number(object.xLeave) : 0,
      agLeave: isSet(object.agLeave) ? globalThis.String(object.agLeave) : "0",
      xFee: isSet(object.xFee) ? globalThis.Number(object.xFee) : 0,
      agFee: isSet(object.agFee) ? globalThis.String(object.agFee) : "0",
      newFee: isSet(object.newFee) ? globalThis.Number(object.newFee) : 0,
      countPlaying: isSet(object.countPlaying) ? globalThis.String(object.countPlaying) : "0",
      minVip: isSet(object.minVip) ? globalThis.String(object.minVip) : "0",
      maxVip: isSet(object.maxVip) ? globalThis.String(object.maxVip) : "0",
  ...
  toJSON(message: Bet): unknown {
    ...
    if (message.countPlaying !== "0") {
      obj.countPlaying = message.countPlaying;
    }
    if (message.minVip !== "0") {
      obj.minVip = message.minVip;
    }
    if (message.maxVip !== "0") {
      obj.maxVip = message.maxVip;
    }
    if (message.betDisableType !== 0) {
