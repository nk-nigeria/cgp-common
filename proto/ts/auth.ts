...
export interface Profile {
  ...
  registrable: boolean;
  vipLevel: string;
  lastOnlineTimeUnix: string;
  createTimeUnix: string;
  remainTimeInputRefCode: string;
...
export const Profile: MessageFns<Profile> = {
  encode(message: Profile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.langAvailables) {
      LangCode.encode(v!, writer.uint32(154).fork()).join();
    }
    if (message.playingMatch !== undefined) {
      PlayingMatch.encode(message.playingMatch, writer.uint32(162).fork()).join();
    }
    if (message.deviceId !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.accountChip = reader.int64().toString();
          continue;
        }
        case 7: {
          if (tag !== 56) {
          ...
          message.bankChip = reader.int64().toString();
          continue;
        }
        case 8: {
          if (tag !== 66) {
        ...
        case 16: {
          ...
          message.lastOnlineTimeUnix = reader.int64().toString();
          continue;
        }
        case 17: {
          if (tag !== 136) {
        ...
        case 18: {
          ...
          message.remainTimeInputRefCode = reader.int64().toString();
          continue;
        }
        case 19: {
          if (tag !== 154) {
        ...
        case 28: {
          ...
          message.lastLoginUnix = reader.int64().toString();
          continue;
        }
        case 29: {
          if (tag !== 232) {
  ...
  fromJSON(object: any): Profile {
    return {
      ...
      accountChip: isSet(object.accountChip) ? globalThis.String(object.accountChip) : "0",
      bankChip: isSet(object.bankChip) ? globalThis.String(object.bankChip) : "0",
      ...
      lastOnlineTimeUnix: isSet(object.lastOnlineTimeUnix) ? globalThis.String(object.lastOnlineTimeUnix) : "0",
      ...
      remainTimeInputRefCode: isSet(object.remainTimeInputRefCode)
        ? globalThis.String(object.remainTimeInputRefCode)
        : "0",
      ...
      lastLoginUnix: isSet(object.lastLoginUnix) ? globalThis.String(object.lastLoginUnix) : "0",
  ...
  toJSON(message: Profile): unknown {
    ...
    if (message.accountChip !== "0") {
      obj.accountChip = message.accountChip;
    }
    if (message.bankChip !== "0") {
      obj.bankChip = message.bankChip;
    }
    if (message.refCode !== "") {
    ...
    if (message.lastOnlineTimeUnix !== "0") {
      obj.lastOnlineTimeUnix = message.lastOnlineTimeUnix;
    }
    if (message.createTimeUnix !== "0") {
      obj.createTimeUnix = message.createTimeUnix;
    }
    if (message.remainTimeInputRefCode !== "0") {
      obj.remainTimeInputRefCode = message.remainTimeInputRefCode;
    }
    ...
    if (message.lastLoginUnix !== "0") {
      obj.lastLoginUnix = message.lastLoginUnix;
    }
    if (message.userSid !== "0") {
...
export const PlayingMatch: MessageFns<PlayingMatch> = {
  encode(message: PlayingMatch, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PlayingMatch {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.leaveTime = reader.int64().toString();
          continue;
        }
        case 4: {
          if (tag !== 32) {
        ...
        case 5: {
          ...
          message.bet = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): PlayingMatch {
    return {
      ...
      leaveTime: isSet(object.leaveTime) ? globalThis.String(object.leaveTime) : "0",
      mcb: isSet(object.mcb) ? globalThis.String(object.mcb) : "0",
      bet: isSet(object.bet) ? globalThis.String(object.bet) : "0",
    };
  },
  ...
  toJSON(message: PlayingMatch): unknown {
    ...
    if (message.leaveTime !== "0") {
      obj.leaveTime = message.leaveTime;
    }
    if (message.mcb !== "0") {
      obj.mcb = message.mcb;
    }
...
export const ListProfile: MessageFns<ListProfile> = {
  encode(message: ListProfile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListProfile {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const SimpleProfile: MessageFns<SimpleProfile> = {
  encode(message: SimpleProfile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.userName !== "") {
    ...
    if (message.playingMatch !== undefined) {
      PlayingMatch.encode(message.playingMatch, writer.uint32(66).fork()).join();
    }
    if (message.userSid !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SimpleProfile {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const ListSimpleProfile: MessageFns<ListSimpleProfile> = {
  encode(message: ListSimpleProfile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.profiles) {
      SimpleProfile.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListSimpleProfile {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuickChatUpdateRequest: MessageFns<QuickChatUpdateRequest> = {
  encode(message: QuickChatUpdateRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuickChatUpdateRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const QuickChatResponse: MessageFns<QuickChatResponse> = {
  encode(message: QuickChatResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.texts) {
      writer.uint32(10).string(v!);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QuickChatResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const LangCode: MessageFns<LangCode> = {
  encode(message: LangCode, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.isoCode !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LangCode {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
