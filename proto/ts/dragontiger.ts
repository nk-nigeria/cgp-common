...
export const DragonTigerBet: MessageFns<DragonTigerBet> = {
  encode(message: DragonTigerBet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.chips !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerBet {
...
export const DragonTigerBetResult: MessageFns<DragonTigerBetResult> = {
  encode(message: DragonTigerBetResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.bet !== undefined) {
      DragonTigerBet.encode(message.bet, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerBetResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DragonTigerPlayerBets: MessageFns<DragonTigerPlayerBets> = {
  encode(message: DragonTigerPlayerBets, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
    ...
    for (const v of message.bets) {
      DragonTigerBet.encode(v!, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerPlayerBets {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DragonTigerPlayerBetResult: MessageFns<DragonTigerPlayerBetResult> = {
  encode(message: DragonTigerPlayerBetResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    for (const v of message.list) {
      DragonTigerBetResult.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerPlayerBetResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DragonTigerDeskCell: MessageFns<DragonTigerDeskCell> = {
  encode(message: DragonTigerDeskCell, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.cell !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerDeskCell {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DragonTigerListDeskCell: MessageFns<DragonTigerListDeskCell> = {
  encode(message: DragonTigerListDeskCell, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.list) {
      DragonTigerDeskCell.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerListDeskCell {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DragonTigerHand: MessageFns<DragonTigerHand> = {
  encode(message: DragonTigerHand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.dragon !== undefined) {
      Card.encode(message.dragon, writer.uint32(10).fork()).join();
    }
    if (message.tiger !== undefined) {
      Card.encode(message.tiger, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerHand {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DragonTigerGameFinish: MessageFns<DragonTigerGameFinish> = {
  encode(message: DragonTigerGameFinish, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.hand !== undefined) {
      DragonTigerHand.encode(message.hand, writer.uint32(10).fork()).join();
    }
    ...
    for (const v of message.listBetResult) {
      DragonTigerPlayerBetResult.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerGameFinish {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DragonTigerHistory: MessageFns<DragonTigerHistory> = {
  encode(message: DragonTigerHistory, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.histories) {
      DragonTigerHand.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerHistory {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DragonTigerPlayer: MessageFns<DragonTigerPlayer> = {
  encode(message: DragonTigerPlayer, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerPlayer {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.vipLevel = reader.int64().toString();
          continue;
        }
        case 5: {
          if (tag !== 42) {
  ...
  fromJSON(object: any): DragonTigerPlayer {
    return {
      ...
      vipLevel: isSet(object.vipLevel) ? globalThis.String(object.vipLevel) : "0",
...
export const DragonTigerUpdateTable: MessageFns<DragonTigerUpdateTable> = {
  encode(message: DragonTigerUpdateTable, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.notablePlayers) {
      DragonTigerPlayer.encode(v!, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerUpdateTable {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DragonTigerUpdateDesk: MessageFns<DragonTigerUpdateDesk> = {
  encode(message: DragonTigerUpdateDesk, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.userBet !== undefined) {
      DragonTigerPlayerBets.encode(message.userBet, writer.uint32(42).fork()).join();
    }
    if (message.deskCell !== undefined) {
      DragonTigerListDeskCell.encode(message.deskCell, writer.uint32(50).fork()).join();
    }
    if (message.history !== undefined) {
      DragonTigerHistory.encode(message.history, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerUpdateDesk {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const DragonTigerActionReject: MessageFns<DragonTigerActionReject> = {
  encode(message: DragonTigerActionReject, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.reason !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DragonTigerActionReject {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
