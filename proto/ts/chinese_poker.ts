...
export interface ScoreResult {
  ...
  middleFactor: string;
  backFactor: string;
  frontBonusFactor: string;
  middleBonusFactor: string;
  backBonusFactor: string;
...
export const HandBonus: MessageFns<HandBonus> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.factor = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): HandBonus {
    return {
      ...
      factor: isSet(object.factor) ? globalThis.String(object.factor) : "0",
    };
  },
...
export const HandResult: MessageFns<HandResult> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.point = reader.uint64().toString();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.lpoint = reader.uint64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): HandResult {
    return {
      ...
      lpoint: isSet(object.lpoint) ? globalThis.String(object.lpoint) : "0",
    };
  },
...
export const ScoreResult: MessageFns<ScoreResult> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.frontFactor = reader.int64().toString();
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.middleFactor = reader.int64().toString();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.backFactor = reader.int64().toString();
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.frontBonusFactor = reader.int64().toString();
          continue;
        }
        case 5: {
          if (tag !== 40) {
          ...
          message.middleBonusFactor = reader.int64().toString();
          continue;
        }
        case 6: {
          if (tag !== 48) {
          ...
          message.backBonusFactor = reader.int64().toString();
          continue;
        }
        case 7: {
          if (tag !== 56) {
          ...
          message.naturalFactor = reader.int64().toString();
          continue;
        }
        case 8: {
          if (tag !== 64) {
          ...
          message.bonusFactor = reader.int64().toString();
          continue;
        }
        case 9: {
          if (tag !== 72) {
          ...
          message.scoop = reader.int64().toString();
          continue;
        }
        case 10: {
          if (tag !== 80) {
        ...
        case 11: {
          ...
          message.totalFactor = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ScoreResult {
    return {
      frontFactor: isSet(object.frontFactor) ? globalThis.String(object.frontFactor) : "0",
      middleFactor: isSet(object.middleFactor) ? globalThis.String(object.middleFactor) : "0",
      backFactor: isSet(object.backFactor) ? globalThis.String(object.backFactor) : "0",
      frontBonusFactor: isSet(object.frontBonusFactor) ? globalThis.String(object.frontBonusFactor) : "0",
      middleBonusFactor: isSet(object.middleBonusFactor) ? globalThis.String(object.middleBonusFactor) : "0",
      backBonusFactor: isSet(object.backBonusFactor) ? globalThis.String(object.backBonusFactor) : "0",
      naturalFactor: isSet(object.naturalFactor) ? globalThis.String(object.naturalFactor) : "0",
      bonusFactor: isSet(object.bonusFactor) ? globalThis.String(object.bonusFactor) : "0",
      scoop: isSet(object.scoop) ? globalThis.String(object.scoop) : "0",
      numHandWin: isSet(object.numHandWin) ? globalThis.Number(object.numHandWin) : 0,
      totalFactor: isSet(object.totalFactor) ? globalThis.String(object.totalFactor) : "0",
    };
  },
  ...
  toJSON(message: ScoreResult): unknown {
    const obj: any = {};
    if (message.frontFactor !== "0") {
      obj.frontFactor = message.frontFactor;
    }
    if (message.middleFactor !== "0") {
      obj.middleFactor = message.middleFactor;
    }
    if (message.backFactor !== "0") {
      obj.backFactor = message.backFactor;
    }
    if (message.frontBonusFactor !== "0") {
      obj.frontBonusFactor = message.frontBonusFactor;
    }
    if (message.middleBonusFactor !== "0") {
      obj.middleBonusFactor = message.middleBonusFactor;
    }
    if (message.backBonusFactor !== "0") {
      obj.backBonusFactor = message.backBonusFactor;
    }
    if (message.naturalFactor !== "0") {
      obj.naturalFactor = message.naturalFactor;
    }
    if (message.bonusFactor !== "0") {
      obj.bonusFactor = message.bonusFactor;
    }
    if (message.scoop !== "0") {
      obj.scoop = message.scoop;
    }
    if (message.numHandWin !== 0) {
      obj.numHandWin = Math.round(message.numHandWin);
    }
    if (message.totalFactor !== "0") {
      obj.totalFactor = message.totalFactor;
    }
    return obj;
  },
