    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.chipsInBank = longToNumber(reader.int64());
          continue;
        }
        case 5: {
          if (tag !== 40) {
        ...
        case 6: {
          ...
          message.balancePrev = longToNumber(reader.int64());
          continue;
        }
        case 7: {
          if (tag !== 56) {
          ...
          message.balanceCurr = longToNumber(reader.int64());
          continue;
        }
        case 8: {
          if (tag !== 64) {
          ...
          message.percenFee = longToNumber(reader.int64());
          continue;
        }
        case 9: {
          if (tag !== 72) {
          ...
          message.amountFee = longToNumber(reader.int64());
          continue;
        }
        case 10: {
          if (tag !== 80) {
          ...
          message.senderSid = longToNumber(reader.int64());
          continue;
        }
        case 11: {
          if (tag !== 88) {
          ...
          message.recipientSid = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
