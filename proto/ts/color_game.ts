...
export const BetResult: MessageFns<BetResult> = {
  encode(message: BetResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    for (const v of message.bets) {
      InfoBet.encode(v!, writer.uint32(18).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BetResult {
...
export const ColorGameFinish: MessageFns<ColorGameFinish> = {
  encode(message: ColorGameFinish, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rollColor !== undefined) {
      ListColor.encode(message.rollColor, writer.uint32(10).fork()).join();
    }
    for (const v of message.betResults) {
      BetResult.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.historyRolls !== undefined) {
      HistoryRoll.encode(message.historyRolls, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ColorGameFinish {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListColor: MessageFns<ListColor> = {
  encode(message: ListColor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListColor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RateColor: MessageFns<RateColor> = {
  encode(message: RateColor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RateColor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const HistoryRoll: MessageFns<HistoryRoll> = {
  encode(message: HistoryRoll, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.listColors) {
      ListColor.encode(v!, writer.uint32(10).fork()).join();
    }
    for (const v of message.rateColors) {
      RateColor.encode(v!, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): HistoryRoll {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const InfoBet: MessageFns<InfoBet> = {
  encode(message: InfoBet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== 0) {
      writer.uint32(8).int32(message.id);
    }
    if (message.chips !== 0) {
    ...
    if (message.emitNewgameEvent !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InfoBet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListInfoBet: MessageFns<ListInfoBet> = {
  encode(message: ListInfoBet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.listBets) {
      InfoBet.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListInfoBet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateDesk: MessageFns<UpdateDesk> = {
  encode(message: UpdateDesk, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.userBets) {
      InfoBet.encode(v!, writer.uint32(34).fork()).join();
    }
    for (const v of message.cellBets) {
      InfoBet.encode(v!, writer.uint32(42).fork()).join();
    }
    if (message.updateHistoryRoll !== false) {
      writer.uint32(48).bool(message.updateHistoryRoll);
    }
    if (message.historyRolls !== undefined) {
      HistoryRoll.encode(message.historyRolls, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpdateDesk {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
