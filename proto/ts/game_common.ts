    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.sid = longToNumber(reader.int64());
          continue;
        }
        case 9: {
          if (tag !== 72) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.amountChipBefore = longToNumber(reader.int64());
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.amountChipCurrent = longToNumber(reader.int64());
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.amountChipAdd = longToNumber(reader.int64());
          continue;
        }
        case 5: {
          if (tag !== 40) {
          ...
          message.amoutChipBet = longToNumber(reader.int64());
          continue;
        }
        case 6: {
          if (tag !== 48) {
          ...
          message.amoutChipFee = longToNumber(reader.int64());
          continue;
        }
        case 7: {
          if (tag !== 56) {
          ...
          message.amoutChipAddPrefee = longToNumber(reader.int64());
          continue;
        }
        case 8: {
          if (tag !== 64) {
          ...
          message.totalChipInMatch = longToNumber(reader.int64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.timePlay = longToNumber(reader.int64());
          continue;
        }
        case 8: {
          if (tag !== 64) {
