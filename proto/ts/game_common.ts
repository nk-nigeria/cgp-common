...
export interface BalanceUpdate {
  userId: string;
  amountChipBefore: string;
  amountChipCurrent: string;
  amountChipAdd: string;
  amoutChipBet: string;
  amoutChipFee: string;
  amoutChipAddPrefee: string;
  totalChipInMatch: string;
}
...
export const Player: MessageFns<Player> = {
  ...
  fromJSON(object: any): Player {
    return {
      ...
      sid: isSet(object.sid) ? globalThis.String(object.sid) : "0",
...
export const Jackpot: MessageFns<Jackpot> = {
  encode(message: Jackpot, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "0") {
...
export const BalanceUpdate: MessageFns<BalanceUpdate> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.amountChipBefore = reader.int64().toString();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.amountChipCurrent = reader.int64().toString();
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.amountChipAdd = reader.int64().toString();
          continue;
        }
        case 5: {
          if (tag !== 40) {
          ...
          message.amoutChipBet = reader.int64().toString();
          continue;
        }
        case 6: {
          if (tag !== 48) {
          ...
          message.amoutChipFee = reader.int64().toString();
          continue;
        }
        case 7: {
          if (tag !== 56) {
          ...
          message.amoutChipAddPrefee = reader.int64().toString();
          continue;
        }
        case 8: {
          if (tag !== 64) {
          ...
          message.totalChipInMatch = reader.int64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): BalanceUpdate {
    return {
      userId: isSet(object.userId) ? globalThis.String(object.userId) : "",
      amountChipBefore: isSet(object.amountChipBefore) ? globalThis.String(object.amountChipBefore) : "0",
      amountChipCurrent: isSet(object.amountChipCurrent) ? globalThis.String(object.amountChipCurrent) : "0",
      amountChipAdd: isSet(object.amountChipAdd) ? globalThis.String(object.amountChipAdd) : "0",
      amoutChipBet: isSet(object.amoutChipBet) ? globalThis.String(object.amoutChipBet) : "0",
      amoutChipFee: isSet(object.amoutChipFee) ? globalThis.String(object.amoutChipFee) : "0",
      amoutChipAddPrefee: isSet(object.amoutChipAddPrefee) ? globalThis.String(object.amoutChipAddPrefee) : "0",
      totalChipInMatch: isSet(object.totalChipInMatch) ? globalThis.String(object.totalChipInMatch) : "0",
    };
  },
  ...
  toJSON(message: BalanceUpdate): unknown {
    ...
    if (message.amountChipBefore !== "0") {
      obj.amountChipBefore = message.amountChipBefore;
    }
    if (message.amountChipCurrent !== "0") {
      obj.amountChipCurrent = message.amountChipCurrent;
    }
    if (message.amountChipAdd !== "0") {
      obj.amountChipAdd = message.amountChipAdd;
    }
    if (message.amoutChipBet !== "0") {
      obj.amoutChipBet = message.amoutChipBet;
    }
    if (message.amoutChipFee !== "0") {
      obj.amoutChipFee = message.amoutChipFee;
    }
    if (message.amoutChipAddPrefee !== "0") {
      obj.amoutChipAddPrefee = message.amoutChipAddPrefee;
    }
    if (message.totalChipInMatch !== "0") {
      obj.totalChipInMatch = message.totalChipInMatch;
    }
    return obj;
  },
...
export const BalanceResult: MessageFns<BalanceResult> = {
  encode(message: BalanceResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.jackpot !== undefined) {
      Jackpot.encode(message.jackpot, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
export const HitJackpotHistory: MessageFns<HitJackpotHistory> = {
  encode(message: HitJackpotHistory, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): HitJackpotHistory {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateTable: MessageFns<UpdateTable> = {
  encode(message: UpdateTable, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.leavePlayers) {
      Player.encode(v!, writer.uint32(34).fork()).join();
    }
    if (message.bet !== "0") {
    ...
    if (message.jpTreasure !== undefined) {
      Jackpot.encode(message.jpTreasure, writer.uint32(82).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpdateTable {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.timePlay = reader.int64().toString();
          continue;
        }
        case 8: {
          if (tag !== 64) {
          ...
          message.remainTime = reader.int64().toString();
          continue;
        }
        case 9: {
          if (tag !== 72) {
  ...
  fromJSON(object: any): UpdateTable {
    return {
      ...
      timePlay: isSet(object.timePlay) ? globalThis.String(object.timePlay) : "0",
      remainTime: isSet(object.remainTime) ? globalThis.String(object.remainTime) : "0",
  ...
  toJSON(message: UpdateTable): unknown {
    ...
    if (message.timePlay !== "0") {
      obj.timePlay = message.timePlay;
    }
    if (message.remainTime !== "0") {
      obj.remainTime = message.remainTime;
    }
    if (message.gameState !== 0) {
