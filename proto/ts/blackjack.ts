...
export const BlackjackAction: MessageFns<BlackjackAction> = {
  encode(message: BlackjackAction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackAction {
...
export const BlackjackBet: MessageFns<BlackjackBet> = {
  encode(message: BlackjackBet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.chips !== "0") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackBet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const BlackjackBetResult: MessageFns<BlackjackBetResult> = {
  encode(message: BlackjackBetResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackBetResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.betAmount = reader.int64().toString();
          continue;
        }
        case 2: {
          if (tag !== 16) {
  ...
  fromJSON(object: any): BlackjackBetResult {
    return {
      betAmount: isSet(object.betAmount) ? globalThis.String(object.betAmount) : "0",
...
export const BlackjackPlayerBet: MessageFns<BlackjackPlayerBet> = {
  encode(message: BlackjackPlayerBet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    ...
    if (message.balance !== undefined) {
      BalanceUpdate.encode(message.balance, writer.uint32(114).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackPlayerBet {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.insurance = reader.int64().toString();
          continue;
        }
        case 3: {
          if (tag !== 24) {
  ...
  fromJSON(object: any): BlackjackPlayerBet {
    return {
      userId: isSet(object.userId) ? globalThis.String(object.userId) : "",
      insurance: isSet(object.insurance) ? globalThis.String(object.insurance) : "0",
      first: isSet(object.first) ? globalThis.String(object.first) : "0",
      second: isSet(object.second) ? globalThis.String(object.second) : "0",
...
export const BlackjackPLayerBetResult: MessageFns<BlackjackPLayerBetResult> = {
  encode(message: BlackjackPLayerBetResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.insurance !== undefined) {
      BlackjackBetResult.encode(message.insurance, writer.uint32(18).fork()).join();
    }
    if (message.first !== undefined) {
      BlackjackBetResult.encode(message.first, writer.uint32(26).fork()).join();
    }
    if (message.second !== undefined) {
      BlackjackBetResult.encode(message.second, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackPLayerBetResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const BlackjackUpdateDeal: MessageFns<BlackjackUpdateDeal> = {
  encode(message: BlackjackUpdateDeal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.hand !== undefined) {
      BlackjackPlayerHand.encode(message.hand, writer.uint32(50).fork()).join();
    }
    for (const v of message.allPlayerHand) {
      BlackjackPlayerHand.encode(v!, writer.uint32(58).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackUpdateDeal {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const BlackjackLegalActions: MessageFns<BlackjackLegalActions> = {
  encode(message: BlackjackLegalActions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackLegalActions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const BlackjackHand: MessageFns<BlackjackHand> = {
  encode(message: BlackjackHand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackHand {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const BlackjackPlayerHand: MessageFns<BlackjackPlayerHand> = {
  encode(message: BlackjackPlayerHand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.first !== undefined) {
      BlackjackHand.encode(message.first, writer.uint32(18).fork()).join();
    }
    if (message.second !== undefined) {
      BlackjackHand.encode(message.second, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackPlayerHand {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const BlackjackPlayerTurn: MessageFns<BlackjackPlayerTurn> = {
  encode(message: BlackjackPlayerTurn, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.isPlayer !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackPlayerTurn {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const BlackjackUpdateDesk: MessageFns<BlackjackUpdateDesk> = {
  encode(message: BlackjackUpdateDesk, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.bet !== undefined) {
      BlackjackPlayerBet.encode(message.bet, writer.uint32(50).fork()).join();
    }
    if (message.isUpdateLegalAction !== false) {
      writer.uint32(56).bool(message.isUpdateLegalAction);
    }
    if (message.actions !== undefined) {
      BlackjackLegalActions.encode(message.actions, writer.uint32(66).fork()).join();
    }
    if (message.isSplitHand !== false) {
      writer.uint32(72).bool(message.isSplitHand);
    }
    if (message.hand !== undefined) {
      BlackjackPlayerHand.encode(message.hand, writer.uint32(82).fork()).join();
    }
    if (message.isBankerNotBlackjack !== false) {
      writer.uint32(88).bool(message.isBankerNotBlackjack);
    }
    for (const v of message.playersBet) {
      BlackjackPlayerBet.encode(v!, writer.uint32(98).fork()).join();
    }
    if (message.error !== undefined) {
      Error.encode(message.error, writer.uint32(106).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackUpdateDesk {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
...
export const BlackjackUpdateFinish: MessageFns<BlackjackUpdateFinish> = {
  encode(message: BlackjackUpdateFinish, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.betResults) {
      BlackjackPLayerBetResult.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BlackjackUpdateFinish {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
