...
type Bet struct {
	...
	AgJoin    float32 `protobuf:"fixed32,6,opt,name=ag_join,json=agJoin,proto3" json:"ag_join,omitempty"`
	XPlayNow  float32 `protobuf:"fixed32,7,opt,name=x_play_now,json=xPlayNow,proto3" json:"x_play_now,omitempty"`
	AgPlayNow float32 `protobuf:"fixed32,8,opt,name=ag_play_now,json=agPlayNow,proto3" json:"ag_play_now,omitempty"`
	XLeave    float32 `protobuf:"fixed32,9,opt,name=x_leave,json=xLeave,proto3" json:"x_leave,omitempty"`
	AgLeave   float32 `protobuf:"fixed32,10,opt,name=ag_leave,json=agLeave,proto3" json:"ag_leave,omitempty"`
	XFee      float32 `protobuf:"fixed32,11,opt,name=x_fee,json=xFee,proto3" json:"x_fee,omitempty"`
	AgFee     float32 `protobuf:"fixed32,12,opt,name=ag_fee,json=agFee,proto3" json:"ag_fee,omitempty"`
...
func (x *Bet) GetAgPlayNow() float32 {
	if x != nil {
		return x.AgPlayNow
	}
	return 0
...
var file_match_api_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x18, 0x06, 0x20, 0x01, 0x28, 0x02, 0x52, 0x06, 0x61, 0x67, 0x4a, 0x6f, 0x69, 0x6e,
	...
	0x01, 0x28, 0x02, 0x52, 0x09, 0x61, 0x67, 0x50, 0x6c, 0x61, 0x79, 0x4e, 0x6f, 0x77, 0x12, 0x17,
	...
	0x61, 0x76, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x02, 0x52, 0x07, 0x61, 0x67, 0x4c, 0x65, 0x61,
	...
	0x65, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x02, 0x52, 0x05, 0x61, 0x67, 0x46, 0x65, 0x65, 0x12, 0x17,
