...
const file_auth_api_proto_rawDesc = "" +
	"\n" +
	"\x0eauth_api.proto\x12\x03api\"V\n" +
	...
	"\bpassword\x18\x02 \x01(\tR\bpassword\"\xf1\a\n" +
	"\aProfile\x12\x17\n" +
	...
	"\x1aremain_time_input_ref_code\x18\x12 \x01(\x03R\x16remainTimeInputRefCode\x126\n" +
	"\x0flang_availables\x18\x13 \x03(\v2\r.api.LangCodeR\x0elangAvailables\x126\n" +
	"\rplaying_match\x18\x14 \x01(\v2\x11.api.PlayingMatchR\fplayingMatch\x12\x1b\n" +
	...
	"\x03bet\x18\x05 \x01(\x03R\x03bet\"7\n" +
	"\vListProfile\x12(\n" +
	"\bprofiles\x18\x01 \x03(\v2\f.api.ProfileR\bprofiles\"\xb0\x02\n" +
	...
	"\tvip_level\x18\a \x01(\x03R\bvipLevel\x126\n" +
	"\rplaying_match\x18\b \x01(\v2\x11.api.PlayingMatchR\fplayingMatch\x12\x19\n" +
	"\buser_sid\x18\t \x01(\x03R\auserSid\"C\n" +
	"\x11ListSimpleProfile\x12.\n" +
	"\bprofiles\x18\x01 \x03(\v2\x12.api.SimpleProfileR\bprofiles\".\n" +
	...
	"\n" +
	"source_url\x18\x03 \x01(\tR\tsourceUrlB0Z.github.com/nakamaFramework/cgp-bing-module/apib\x06proto3"
