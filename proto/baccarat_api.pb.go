...
const file_baccarat_api_proto_rawDesc = "" +
	"\n" +
	"\x12baccarat_api.proto\x12\x03api\x1a\x1cchinese_poker_game_api.proto\"M\n" +
	"\vBaccaratBet\x12\x14\n" +
	"\x05chips\x18\x02 \x01(\x03R\x05chips\x12(\n" +
	"\x04cell\x18\x03 \x01(\x0e2\x14.api.BaccaratBetCellR\x04cell\"N\n" +
	"\x11BaccaratBetResult\x12\"\n" +
	"\x03bet\x18\x01 \x01(\v2\x10.api.BaccaratBetR\x03bet\x12\x15\n" +
	"\x06is_win\x18\x02 \x01(\bR\x05isWin\"\x8f\x01\n" +
	"\x11BaccaratPlayerBet\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12;\n" +
	"\vaction_type\x18\x02 \x01(\x0e2\x1a.api.BaccaratBetActionTypeR\n" +
	"actionType\x12$\n" +
	"\x04bets\x18\x03 \x03(\v2\x10.api.BaccaratBetR\x04bets\"`\n" +
	"\x17BaccaratPlayerBetResult\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12,\n" +
	"\x05lists\x18\x02 \x03(\v2\x16.api.BaccaratBetResultR\x05lists\"^\n" +
	"\fBaccaratHand\x12\x1f\n" +
	"\x05cards\x18\x01 \x03(\v2\t.api.CardR\x05cards\x12\x14\n" +
	"\x05point\x18\x02 \x01(\x05R\x05point\x12\x17\n" +
	"\ais_pair\x18\x03 \x01(\bR\x06isPair\"e\n" +
	"\rBaccaratHands\x12)\n" +
	"\x06banker\x18\x01 \x01(\v2\x11.api.BaccaratHandR\x06banker\x12)\n" +
	"\x06player\x18\x02 \x01(\v2\x11.api.BaccaratHandR\x06player\"\xb7\x01\n" +
	"\x12BaccaratGameFinish\x12&\n" +
	"\x04hand\x18\x01 \x01(\v2\x12.api.BaccaratHandsR\x04hand\x121\n" +
	"\twin_cells\x18\x03 \x03(\x0e2\x14.api.BaccaratBetCellR\bwinCells\x12F\n" +
	"\x10list_bet_results\x18\x04 \x03(\v2\x1c.api.BaccaratPlayerBetResultR\x0elistBetResults\"s\n" +
	"\x13BaccaratBetCellInfo\x12(\n" +
	"\x04cell\x18\x01 \x01(\x0e2\x14.api.BaccaratBetCellR\x04cell\x12\x14\n" +
	...
	"\x16is_update_game_history\x18\x04 \x01(\bR\x13isUpdateGameHistory\x121\n" +
	"\buser_bet\x18\x05 \x01(\v2\x16.api.BaccaratPlayerBetR\auserBet\x127\n" +
	"\n" +
	"desk_cells\x18\x06 \x03(\v2\x18.api.BaccaratBetCellInfoR\tdeskCells\x124\n" +
	"\ahistory\x18\a \x01(\v2\x1a.api.BaccaratSimpleHistoryR\ahistory\"Q\n" +
	"\x17BaccaratBetActionReject\x126\n" +
	"\x06reason\x18\x01 \x01(\x0e2\x1e.api.BaccaratBetRejectedReasonR\x06reason\"|\n" +
	"\x12BaccaratUpdateDeal\x12\x1b\n" +
	"\tis_player\x18\x01 \x01(\bR\bisPlayer\x12\x1f\n" +
	"\x05cards\x18\x02 \x03(\v2\t.api.CardR\x05cards\x12(\n" +
	"\x05hands\x18\x03 \x01(\v2\x12.api.BaccaratHandsR\x05hands*\xa5\x02\n" +
	...
	"IBACCARAT_BET_REJECTED_REASON_BACCARAT_BET_REJECTED_EXCEED_MAX_BET_ALLOWED\x10\x04B0Z.github.com/nakamaFramework/cgp-bing-module/apib\x06proto3"

var (
	file_baccarat_api_proto_rawDescOnce sync.Once
	file_baccarat_api_proto_rawDescData []byte
)

func file_baccarat_api_proto_rawDescGZIP() []byte {
	file_baccarat_api_proto_rawDescOnce.Do(func() {
		file_baccarat_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_baccarat_api_proto_rawDesc), len(file_baccarat_api_proto_rawDesc)))
	})
...
func file_baccarat_api_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_baccarat_api_proto_rawDesc), len(file_baccarat_api_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
