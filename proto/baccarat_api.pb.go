...
const (
	BaccaratBetCell_BACCARAT_CELL_UNSPECIFIED BaccaratBetCell = 0
	BaccaratBetCell_BACCARAT_CELL_PLAYER      BaccaratBetCell = 1
	BaccaratBetCell_BACCARAT_CELL_BANKER      BaccaratBetCell = 2
	BaccaratBetCell_BACCARAT_CELL_TIE         BaccaratBetCell = 3
	BaccaratBetCell_BACCARAT_CELL_PLAYER_PAIR BaccaratBetCell = 4
	BaccaratBetCell_BACCARAT_CELL_BANKER_PAIR BaccaratBetCell = 5
)

// Enum value maps for BaccaratBetCell.
var (
	BaccaratBetCell_name = map[int32]string{
		0: "BACCARAT_CELL_UNSPECIFIED",
		1: "BACCARAT_CELL_PLAYER",
		2: "BACCARAT_CELL_BANKER",
		3: "BACCARAT_CELL_TIE",
		4: "BACCARAT_CELL_PLAYER_PAIR",
		5: "BACCARAT_CELL_BANKER_PAIR",
	}
...
const (
	BaccaratBetActionType_BACCARAT_BET_NORMAL BaccaratBetActionType = 0
	BaccaratBetActionType_BACCARAT_BET_REBET  BaccaratBetActionType = 1
	BaccaratBetActionType_BACCARAT_BET_DOUBLE BaccaratBetActionType = 2
)

// Enum value maps for BaccaratBetActionType.
var (
	BaccaratBetActionType_name = map[int32]string{
		0: "BACCARAT_BET_NORMAL",
		1: "BACCARAT_BET_REBET",
		2: "BACCARAT_BET_DOUBLE",
	}
...
const (
	BaccaratBetRejectedReason_BACCARAT_BET_REJECTED_UNSPECIFIED            BaccaratBetRejectedReason = 0
	BaccaratBetRejectedReason_BACCARAT_BET_REJECTED_BALANCE_NOT_ENOUGH     BaccaratBetRejectedReason = 1
	BaccaratBetRejectedReason_BACCARAT_BET_REJECTED_PREVIOUS_BET_NOT_EXIST BaccaratBetRejectedReason = 2
	BaccaratBetRejectedReason_BACCARAT_BET_REJECTED_ALREADY_BET            BaccaratBetRejectedReason = 3
	BaccaratBetRejectedReason_BACCARAT_BET_REJECTED_EXCEED_MAX_BET_ALLOWED BaccaratBetRejectedReason = 4
)

// Enum value maps for BaccaratBetRejectedReason.
var (
	BaccaratBetRejectedReason_name = map[int32]string{
		0: "BACCARAT_BET_REJECTED_UNSPECIFIED",
		1: "BACCARAT_BET_REJECTED_BALANCE_NOT_ENOUGH",
		2: "BACCARAT_BET_REJECTED_PREVIOUS_BET_NOT_EXIST",
		3: "BACCARAT_BET_REJECTED_ALREADY_BET",
		4: "BACCARAT_BET_REJECTED_EXCEED_MAX_BET_ALLOWED",
	}
...
func (x *BaccaratBet) GetCell() BaccaratBetCell {
	...
	return BaccaratBetCell_BACCARAT_CELL_UNSPECIFIED
}
...
func (x *BaccaratPlayerBet) GetActionType() BaccaratBetActionType {
	...
	return BaccaratBetActionType_BACCARAT_BET_NORMAL
}
...
type BaccaratPlayerBetResult struct {
	...
	UserId string               `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	List   []*BaccaratBetResult `protobuf:"bytes,2,rep,name=list,proto3" json:"list,omitempty"`
}
...
func (x *BaccaratPlayerBetResult) GetList() []*BaccaratBetResult {
	if x != nil {
		return x.List
	}
	return nil
...
type BaccaratHand struct {
	...
	Banker []*Card `protobuf:"bytes,1,rep,name=banker,proto3" json:"banker,omitempty"`
	Player []*Card `protobuf:"bytes,2,rep,name=player,proto3" json:"player,omitempty"`
}
...
func (x *BaccaratHand) GetBanker() []*Card {
	if x != nil {
		return x.Banker
	}
	return nil
...
func (x *BaccaratHand) GetPlayer() []*Card {
	if x != nil {
		return x.Player
	}
	return nil
...
type BaccaratGameFinish struct {
	...
	Hand          *BaccaratHand              `protobuf:"bytes,1,opt,name=hand,proto3" json:"hand,omitempty"`
	...
	ListBetResult []*BaccaratPlayerBetResult `protobuf:"bytes,4,rep,name=list_bet_result,json=listBetResult,proto3" json:"list_bet_result,omitempty"`
}
...
func (x *BaccaratGameFinish) GetHand() *BaccaratHand {
	if x != nil {
		return x.Hand
	}
	return nil
...
func (x *BaccaratGameFinish) GetListBetResult() []*BaccaratPlayerBetResult {
	if x != nil {
...
type BaccaratBetCellInfo struct {
	...
	Chips    int64           `protobuf:"varint,2,opt,name=chips,proto3" json:"chips,omitempty"`
	NUserNet int32           `protobuf:"varint,3,opt,name=n_user_net,json=nUserNet,proto3" json:"n_user_net,omitempty"`
}
...
func (x *BaccaratBetCellInfo) GetNUserNet() int32 {
	if x != nil {
		return x.NUserNet
	}
	return 0
...
func (x *BaccaratHistory) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BaccaratHistory) ProtoMessage() {}

func (x *BaccaratHistory) ProtoReflect() protoreflect.Message {
	mi := &file_baccarat_api_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BaccaratHistory.ProtoReflect.Descriptor instead.
func (*BaccaratHistory) Descriptor() ([]byte, []int) {
	return file_baccarat_api_proto_rawDescGZIP(), []int{7}
}

func (x *BaccaratHistory) GetBankerWin() int32 {
	if x != nil {
		return x.BankerWin
	}
	return 0
...
func (x *BaccaratHistory) GetPlayerWin() int32 {
	if x != nil {
		return x.PlayerWin
	}
	return 0
...
func (x *BaccaratHistory) GetTie() int32 {
	if x != nil {
		return x.Tie
	}
	return 0
...
type BaccaratUpdateDesk struct {
	...
	DeskCell            []*BaccaratBetCellInfo `protobuf:"bytes,6,rep,name=desk_cell,json=deskCell,proto3" json:"desk_cell,omitempty"`
	History             *BaccaratHistory       `protobuf:"bytes,7,opt,name=history,proto3" json:"history,omitempty"`
}
...
func (x *BaccaratUpdateDesk) GetDeskCell() []*BaccaratBetCellInfo {
	if x != nil {
		return x.DeskCell
	}
	return nil
...
func (x *BaccaratUpdateDesk) GetHistory() *BaccaratHistory {
	if x != nil {
		return x.History
	}
	return nil
...
func (x *BaccaratBetActionReject) GetReason() BaccaratBetRejectedReason {
	...
	return BaccaratBetRejectedReason_BACCARAT_BET_REJECTED_UNSPECIFIED
}
...
var file_baccarat_api_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x52, 0x04, 0x62, 0x65, 0x74, 0x73, 0x22, 0x5e, 0x0a, 0x17, 0x42, 0x61, 0x63, 0x63,
	...
	,
	...
	,
	...
	0x01, 0x12, 0x30, 0x0a, 0x2c, 0x42, 0x41, 0x43, 0x43, 0x41, 0x52, 0x41, 0x54, 0x5f, 0x42, 0x45,
	...
	0x54, 0x10, 0x02, 0x12, 0x25, 0x0a, 0x21, 0x42, 0x41, 0x43, 0x43, 0x41, 0x52, 0x41, 0x54, 0x5f,
	0x42, 0x45, 0x54, 0x5f, 0x52, 0x45, 0x4a, 0x45, 0x43, 0x54, 0x45, 0x44, 0x5f, 0x41, 0x4c, 0x52,
	0x45, 0x41, 0x44, 0x59, 0x5f, 0x42, 0x45, 0x54, 0x10, 0x03, 0x12, 0x30, 0x0a, 0x2c, 0x42, 0x41,
	0x43, 0x43, 0x41, 0x52, 0x41, 0x54, 0x5f, 0x42, 0x45, 0x54, 0x5f, 0x52, 0x45, 0x4a, 0x45, 0x43,
	0x54, 0x45, 0x44, 0x5f, 0x45, 0x58, 0x43, 0x45, 0x45, 0x44, 0x5f, 0x4d, 0x41, 0x58, 0x5f, 0x42,
	0x45, 0x54, 0x5f, 0x41, 0x4c, 0x4c, 0x4f, 0x57, 0x45, 0x44, 0x10, 0x04, 0x42, 0x37, 0x5a, 0x35,
...
var file_baccarat_api_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_baccarat_api_proto_goTypes = []interface{}{
	...
	(*BaccaratGameFinish)(nil),      // 8: api.BaccaratGameFinish
	(*BaccaratBetCellInfo)(nil),     // 9: api.BaccaratBetCellInfo
	(*BaccaratHistory)(nil),         // 10: api.BaccaratHistory
	(*BaccaratUpdateDesk)(nil),      // 11: api.BaccaratUpdateDesk
	(*BaccaratBetActionReject)(nil), // 12: api.BaccaratBetActionReject
	(*Card)(nil),                    // 13: api.Card
}
var file_baccarat_api_proto_depIdxs = []int32{
	...
	4,  // 4: api.BaccaratPlayerBetResult.list:type_name -> api.BaccaratBetResult
	13, // 5: api.BaccaratHand.banker:type_name -> api.Card
	13, // 6: api.BaccaratHand.player:type_name -> api.Card
	7,  // 7: api.BaccaratGameFinish.hand:type_name -> api.BaccaratHand
	0,  // 8: api.BaccaratGameFinish.win_cells:type_name -> api.BaccaratBetCell
	6,  // 9: api.BaccaratGameFinish.list_bet_result:type_name -> api.BaccaratPlayerBetResult
	0,  // 10: api.BaccaratBetCellInfo.cell:type_name -> api.BaccaratBetCell
	5,  // 11: api.BaccaratUpdateDesk.user_bet:type_name -> api.BaccaratPlayerBet
	9,  // 12: api.BaccaratUpdateDesk.desk_cell:type_name -> api.BaccaratBetCellInfo
	10, // 13: api.BaccaratUpdateDesk.history:type_name -> api.BaccaratHistory
	2,  // 14: api.BaccaratBetActionReject.reason:type_name -> api.BaccaratBetRejectedReason
