...
type GameConfig struct {
	...
	RatioBasket   int64 `protobuf:"varint,5,opt,name=ratio_basket,json=ratioBasket,proto3" json:"ratio_basket,omitempty"`
}
...
func (x *GameConfig) GetRatioBasket() int64 {
	if x != nil {
...
var file_slots_game_proto_rawDesc = []byte{
	...
	0x6b, 0x65, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x72, 0x61, 0x74, 0x69, 0x6f,
